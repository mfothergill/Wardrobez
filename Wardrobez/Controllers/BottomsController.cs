...
namespace Wardrobez.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomsID,BottomsName,BottomsPhoto,BottomsType,BottomsColor,BottomsSeason,BottomsOccasion")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomsID,BottomsName,BottomsPhoto,BottomsType,BottomsColor,BottomsSeason,BottomsOccasion")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
